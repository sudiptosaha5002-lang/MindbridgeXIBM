...
import { canDecodeAvif, optimizeImage } from '../../../../server/image-optimizer';
...
export async function getBlurImage(content, extension, imageSize, { basePath, outputPath, isDev, tracing = ()=>({
    ...
    const isValidBlurExtension = VALID_BLUR_EXT.includes(extension) || extension === 'avif' && canDecodeAvif(null);
