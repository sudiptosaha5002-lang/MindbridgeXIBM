...
async function getBlurImage(content, extension, imageSize, { basePath, outputPath, isDev, tracing = ()=>({
    ...
    const isValidBlurExtension = VALID_BLUR_EXT.includes(extension) || extension === 'avif' && (0, _imageoptimizer.canDecodeAvif)(null);
    if (isValidBlurExtension && !(0, _isanimated.default)(content)) {
